...
import { deleteSelected, editSelected,previewSelected } from "../control/EventsControl.js";
...
class EventActions extends AirElement { 
    ...
    view() { 
        ...
        <button class="button is-primary is-small" ?disabled=${!isOneRowSelected(this.state.list)} @click=${_ => previewSelected()}>preview</button>
